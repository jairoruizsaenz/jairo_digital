...
var highlight_stroke_width = 3,
    ...
    var breaks = ["Movie","Director","Actor"];
...
var simulation = d3.forceSimulation()
    .force("link", d3.forceLink().id(function(d) { return d.Name; }).distance(3))
    ...
    d3.json(path, function(error, graph) {
        ...
        var num_movies = 0;
        var minYear = Number(d3.min(graph.nodes, function(d) { if (d.Grupo == "Movie") { 
            num_movies = num_movies + 1;
            return d.Fecha;          
        }}));
      
        var maxYear = Number(d3.max(graph.nodes, function(d) { if (d.Grupo == "Movie") { return d.Fecha; }}))+1;
        ...
        function set_highlight(d)
        {
            ...
            link
                ...
                return o.source.Name == d.Name || o.target.Name == d.Name ? highlight_stroke_width : default_stroke_width;})

                .style("stroke", function(o) {
                return o.source.Name == d.Name || o.target.Name == d.Name ? highlight_color : default_stroke_color;})

                .attr("stroke-opacity", function(o) {
                return o.source.Name == d.Name || o.target.Name == d.Name ? highlight_stroke_opacity : default_stroke_opacity;});             
        }
        ...
        {    
            ...
            link
                ...
                .attr("stroke-opacity", function(o) {
                return o.source.Name == d.Name || o.target.Name == d.Name ? highlight_stroke_opacity : highlight_trans;}); 
        }
